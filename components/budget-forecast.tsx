...
function ForecastVsActual() {
  ...
  return <Card className="mb-5 overflow-hidden bg-[#26342b] text-white"><CardContent className="p-6">
    ...
    {actual && <>
      <div className="mt-4 grid gap-5 sm:grid-cols-3">
        ...
        <div>
          ...
          <div className={cn("mt-2 flex items-center gap-2 text-2xl font-semibold", ahead ? "text-emerald-300" : "text-[#ef9a75]")}>
