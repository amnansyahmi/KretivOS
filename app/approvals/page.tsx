...
export default function ApprovalInboxPage() {
  ...
  return (
    <WorkspacePage
      ...
      actions={<Button variant="outline" className="bg-card" onClick={() => void load()} disabled={loading}><RefreshCw className={cn("h-4 w-4", loading && "animate-spin")} />Refresh</Button>}
    >
